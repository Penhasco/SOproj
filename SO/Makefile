...
HEADERS  := $(wildcard */*.h)
OBJECTS  := $(SOURCES:.c=.o)
TARGET_EXECS := tests/mt1 tests/mt2 tests/mt3 tests/test1 tests/copy_to_external_simple tests/copy_to_external_errors tests/write_10_blocks_spill tests/write_10_blocks_simple tests/write_more_than_10_blocks_simple
...
tests/mt1: tests/mt1.o fs/operations.o fs/state.o
tests/mt2: tests/mt2.o fs/operations.o fs/state.o
tests/mt3: tests/mt3.o fs/operations.o fs/state.o
