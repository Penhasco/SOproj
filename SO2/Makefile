...
HEADERS  := $(wildcard */*.h)
OBJECTS  := $(SOURCES:.c=.o)
TARGET_EXECS := fs/tfs_server tests/simple_test tests/lib_destroy_after_all_closed_test tests/client_server_simple_test
...
tests/simple_test: tests/simple_test.o client/tecnicofs_client_api.o
